      ...
      <div class="py-container">
        ...
        <div class="details clearfix">
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li v-for="item in $store.state.product.searchProductResult.goodsList" :key="item.id" class="yui3-u-1-5">
                <div class="list-wrap">
                  <div class="p-img">
...
export default {
  ...
  watch:{
    "$route.query":{
      handler(query){
        this.$store.dispatch("product/searchProductAsync", query);
