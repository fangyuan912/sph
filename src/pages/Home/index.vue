<template>
  <div>
    <div>
      ...
      <!--楼层-->
      <Floor v-for="item in $store.state.product.floorList" :key="item.id" :floorInfo="item"></Floor>
...
import BrandAdv from "@/pages/Home/BrandAdv";
import Floor from "@/pages/Home/Floor";
import RankList from "@/pages/Home/RankList";
import TodayRecommend from "@/pages/Home/TodayRecommend";
export default {
  name: "Home",
  components:{FocusAdv,BrandAdv,Floor,TodayRecommend,RankList},
  mounted(){
