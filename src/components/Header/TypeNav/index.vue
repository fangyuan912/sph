<template>
  <div class="type-nav">
    <div class="container">
      <div @mouseleave="categoryHide" class="nav-left">
        <h2 @mouseenter="isShow=true" class="all">全部商品分类</h2>
...
<script>
import {getBaseCategoryList} from "@/api/product.js";
...
export default {
  ...
  mounted(){
    ...
    // })
    //非简写
    //this.$store.dispath("product/getBaseCategoryListAsync",15)
